...
kind1, kind2 :: Kind
kind1 = liftedTypeKind `mkVisFunTyM` liftedTypeKind
kind2 = liftedTypeKind `mkVisFunTyM` kind1
...
genAuxBindSpec dflags loc (DerivCon2Tag tycon)
  ...
  where
    ...
    sig_ty = mkLHsSigWcType $ L loc $ XHsType $ NHsCoreTy $
             ...
             mkParentType tycon `mkVisFunTyU` intPrimTy
...
genAuxBindSpec dflags loc (DerivTag2Con tycon)
  ...
  where
    sig_ty = mkLHsSigWcType $ L loc $
             ...
             intTy `mkVisFunTyU` mkParentType tycon
