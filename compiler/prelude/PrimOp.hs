...
primOpType op
  = case primOpInfo op of
    ...
    GenPrimOp _occ tyvars arg_tys res_ty ->
        mkSpecForAllTys tyvars (mkVisFunTysU arg_tys res_ty)
...
dyadic_fun_ty  ty = mkVisFunTysU [ty, ty] ty
monadic_fun_ty ty = mkVisFunTyU  ty ty
compare_fun_ty ty = mkVisFunTysU [ty, ty] intPrimTy
